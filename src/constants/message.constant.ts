...
export class Message {
  static readonly CREATED_MESSAGE = 'Creado Correctamente';
  static readonly UPDATED_MESSAGE = 'Modificado Correctamente';
  static readonly DELETED_MESSAGE = 'Eliminado Correctamente';
  static readonly FOUND_MESSAGE = 'Encontrado';
  static readonly NOT_FOUND_MESSAGE = 'No Encontrado';

  static readonly ERROR_UPDATED_MESSAGE = 'Error al modificar';
